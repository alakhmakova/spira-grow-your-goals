...
const mockGoals: Goal[] = [
  {
    ...
    activeOptionId: "opt1",
    will: "This goal is important to evaluate the developer's ability to create a good user experience and deliver quality technical implementation — critical factors in deciding whether the Spira's developer is a strong candidate worth advancing in the recruitment process.",
    resources: [
      { id: "r1", type: "email", email: "anastasiya.lakhmakova@gmail.com" },
      { id: "r2", type: "link", name: "GitHub Repository", url: "https://github.com/alakhmakova/spira-grow-your-goals" },
      { id: "r3", type: "text", content: "The developer of this application is Jensen yrkeshögskola student Anastasiya Lakhmakova" },
      { id: "r4", type: "picture", name: "Grades during education at Jensen", fileData: "https://github.com/user-attachments/assets/aa64e054-cfc9-45c6-ba53-c38a3d69ecbf", fileName: "grades.png" },
      { id: "r5", type: "document", name: "CV Anastasiya Lakhmakova", fileData: "https://github.com/user-attachments/files/24296184/CV.Java.Systemutvecklare.Anastasiya.Lakhmakova.3.pdf", fileName: "CV_Java_Systemutvecklare_Anastasiya_Lakhmakova.pdf" },
    ],
    achievability: 10,
    ...
    targets: [
      {
        id: "t4",
        goalId: "2",
        name: "Create a number-type target",
        type: "number",
      ...
      },
      {
        id: "t5",
        goalId: "2",
        name: "Create a success-type target",
        type: "success",
      ...
      },
      {
        id: "t6",
        goalId: "2",
        name: "Create a tasks-type target",
        type: "tasks",
        createdAt: new Date("2024-01-18"),
        progress: 0,
        tasks: [
          { id: "task4", targetId: "t6", name: "Add first task", isCompleted: false, createdAt: new Date("2024-01-18") },
          { id: "task5", targetId: "t6", name: "Add second task", isCompleted: false, createdAt: new Date("2024-01-18") },
        ],
      },
    ],
  },
    ...
    targets: [
      {
        id: "t7",
        goalId: "3",
        name: "Create goal without option but with targets",
        type: "success",
      ...
      },
      {
        id: "t8",
        goalId: "3",
        name: "Create goal without option, add option from goal page, then add targets",
        type: "success",
      ...
      },
      {
        id: "t9",
        goalId: "3",
        name: "Create goal without option, add targets, then add option",
        type: "success",
      ...
      },
      {
        id: "t10",
        goalId: "3",
        name: "Create goal with one option from form, then add targets",
        type: "success",
      ...
      },
      {
        id: "t11",
        goalId: "3",
        name: "Create goal with 2 options from form, then add targets",
        type: "success",
        createdAt: new Date("2024-01-25"),
        progress: 0,
        isCompleted: false,
  ...
  },
  {
    ...
    resources: [
      ...
      { id: "r8", type: "text", content: "GROW stands for: Goal, Reality, Options (or Obstacles), Will (or Way Forward)" },
    ],
    achievability: 7,
    ...
    targets: [
      {
        id: "t12",
        goalId: "4",
        name: "Read articles about GROW model",
        type: "number",
      ...
      },
      {
        id: "t13",
        goalId: "4",
        name: "Complete online GROW coaching course",
        type: "success",
      ...
      },
      {
        id: "t14",
        goalId: "4",
        name: "Practice GROW model steps",
        type: "tasks",
        createdAt: new Date("2024-01-28"),
        progress: 25,
        tasks: [
          { id: "task6", targetId: "t14", name: "Practice Goal setting", isCompleted: true, createdAt: new Date("2024-01-28") },
          { id: "task7", targetId: "t14", name: "Practice Reality assessment", isCompleted: false, createdAt: new Date("2024-01-28") },
          { id: "task8", targetId: "t14", name: "Practice Options exploration", isCompleted: false, createdAt: new Date("2024-01-28") },
          { id: "task9", targetId: "t14", name: "Practice Will commitment", isCompleted: false, createdAt: new Date("2024-01-28") },
        ],
      },
    ],
  },
